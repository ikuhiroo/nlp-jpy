...
def show(model, tokenizer, sentence_a, sentence_b, masked, mask_id, bert_version):
    vis_html = """
    ...
    attn_data = get_attention_bert(model, tokenizer, sentence_a, sentence_b, masked, mask_id, bert_version)
    params = {
        'attention': attn_data,
        'default_filter': "all"
    }
